      ...
      <article className="legal-document section-shell">
        ...
        <div>
          <section>
            ...
            <p>
              The Planeon website, blueprint, explorer, assessment, and related
              materials provide general architecture information. They are not
              professional advice, a certification, a warranty, or evidence that
              any particular system has been implemented or accepted.
            </p>
          </section>
          <section>
          ...
          <section>
            ...
            <p>
              Dated claims and technology references can change. External links
              are provided for context; Planeon does not control their
          ...
          <section>
            ...
            <p>
              Planeon names, marks, visual identity, and original site materials
              remain the property of their respective owners. Third-party names
              and marks belong to their owners and do not imply endorsement.
            </p>
          </section>
          <section>
            <h2>Questions</h2>
