      ...
      <article className="legal-document section-shell">
        ...
        <div>
          ...
          <section>
            ...
            <p>
              Our hosting providers may process standard technical request data,
              such as an IP address, browser information, requested URL, and
              timestamp, to deliver and protect the site. Their handling of that
              data is governed by their own service terms and privacy practices.
            </p>
          </section>
          <section>
